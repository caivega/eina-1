...
EAPI size_t
eina_str_length_vprintf(const char *format, va_list args)
{
    char c;
    size_t len;
...
EAPI char *
eina_str_dup_vprintf(const char *format, va_list args)
{
    size_t length;
    char *ret;
    va_list copy;
     ...
     */
    va_copy(copy, args);
    length = eina_str_length_vprintf(format, copy);
    va_end(copy);
...
EAPI char *
eina_str_dup_printf(const char *format, ...)
{
    char *ret;
    va_list args;
